...
type FurnitureInfo struct {
	...
	Count                *int64   `protobuf:"zigzag64,2,req,name=count" json:"count,omitempty"`
...
type HomeRoomSize struct {
	SquareId             *int32   `protobuf:"zigzag32,1,req,name=square_id" json:"square_id,omitempty"`
	MaxX                 *int32   `protobuf:"zigzag32,2,req,name=max_x" json:"max_x,omitempty"`
	MaxY                 *int32   `protobuf:"zigzag32,3,req,name=max_y" json:"max_y,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type RoomDecorateInfo struct {
	Direction            *int32       `protobuf:"zigzag32,1,req,name=direction" json:"direction,omitempty"`
	Pos                  *DecoratePos `protobuf:"bytes,2,req,name=pos" json:"pos,omitempty"`
	Id                   *int32       `protobuf:"zigzag32,3,req,name=id" json:"id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
type RoomFurnitureInfo struct {
	...
	RoomCapacity         *HomeRoomSize       `protobuf:"bytes,2,req,name=room_capacity" json:"room_capacity,omitempty"`
...
type DbHomeInfo struct {
	...
	DepotCapacity        *int32             `protobuf:"zigzag32,3,req,name=depot_capacity" json:"depot_capacity,omitempty"`
	DepotExtandId        *int32             `protobuf:"zigzag32,4,req,name=depot_extand_id" json:"depot_extand_id,omitempty"`
	...
	RoomInfo             *RoomFurnitureInfo `protobuf:"bytes,7,req,name=room_info" json:"room_info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
type S2C_SyncHomeInfo struct {
	...
	Exp                  *int32        `protobuf:"zigzag32,2,req,name=exp" json:"exp,omitempty"`
	DepotCapacity        *int32        `protobuf:"zigzag32,3,req,name=depot_capacity" json:"depot_capacity,omitempty"`
	DepotExtandTime      *int32        `protobuf:"zigzag32,4,req,name=depot_extand_time" json:"depot_extand_time,omitempty"`
	RoomSize             *HomeRoomSize `protobuf:"bytes,5,req,name=room_size" json:"room_size,omitempty"`
...
type S2C_Bag_FurnitureUpdate struct {
	FurnitureInfo        *FurnitureInfo `protobuf:"bytes,1,req,name=furniture_info" json:"furniture_info,omitempty"`
...
type S2C_RoleHomeInfo struct {
	HomeInfo             *DbHomeInfo `protobuf:"bytes,1,req,name=home_info" json:"home_info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
type C2S_BuyHomeShopGood struct {
	RoleIndex            *int64   `protobuf:"zigzag64,1,req,name=role_index" json:"role_index,omitempty"`
	GoodId               *int32   `protobuf:"zigzag32,2,req,name=good_id" json:"good_id,omitempty"`
...
type C2S_HomeDepotSell struct {
	...
	ItemCount            *int32   `protobuf:"zigzag32,3,req,name=item_count" json:"item_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type C2S_UpdateRoomInfo struct {
	RoleIndex            *int64       `protobuf:"zigzag64,1,req,name=role_index" json:"role_index,omitempty"`
	RoomInfo             *NewRoomInfo `protobuf:"bytes,2,req,name=room_info" json:"room_info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
var fileDescriptor_061af2b23dee2f71 = []byte{
	...
	,
}
...
func (m *RoomDecorateInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Pos == nil {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.Pos.Size()))
...
func (m *RoomFurnitureInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RoomCapacity == nil {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.RoomCapacity.Size()))
		n2, err2 := m.RoomCapacity.MarshalTo(dAtA[i:])
		if err2 != nil {
			return 0, err2
		}
		i += n2
	...
	if len(m.WallDecorate) > 0 {
		for _, msg := range m.WallDecorate {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintHouse(dAtA, i, uint64(msg.Size()))
	...
	if len(m.FloorDecorate) > 0 {
		for _, msg := range m.FloorDecorate {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintHouse(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *DbHomeInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DepotFurnitureList) > 0 {
		for _, msg := range m.DepotFurnitureList {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintHouse(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.RoomFurnitureList) > 0 {
		for _, msg := range m.RoomFurnitureList {
			dAtA[i] = 0x32
			i++
			i = encodeVarintHouse(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if m.RoomInfo == nil {
		...
		dAtA[i] = 0x3a
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.RoomInfo.Size()))
...
func (m *NewRoomInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IncreaseList) > 0 {
		for _, msg := range m.IncreaseList {
			dAtA[i] = 0x32
			i++
			i = encodeVarintHouse(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *S2C_SyncHomeInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RoomSize == nil {
		...
		dAtA[i] = 0x2a
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.RoomSize.Size()))
		n4, err4 := m.RoomSize.MarshalTo(dAtA[i:])
		if err4 != nil {
			return 0, err4
		}
		i += n4
...
func (m *S2C_Bag_FurnitureUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FurnitureInfo == nil {
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.FurnitureInfo.Size()))
		n6, err6 := m.FurnitureInfo.MarshalTo(dAtA[i:])
		if err6 != nil {
			return 0, err6
		}
		i += n6
...
func (m *S2C_OtherHomeInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RoomInfo != nil {
		...
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.RoomInfo.Size()))
		n8, err8 := m.RoomInfo.MarshalTo(dAtA[i:])
		if err8 != nil {
			return 0, err8
		}
		i += n8
...
func (m *S2C_RoleHomeInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HomeInfo == nil {
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.HomeInfo.Size()))
		n9, err9 := m.HomeInfo.MarshalTo(dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += n9
...
func (m *C2S_UpdateRoomInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RoomInfo == nil {
		...
		i++
		i = encodeVarintHouse(dAtA, i, uint64(m.RoomInfo.Size()))
		n10, err10 := m.RoomInfo.MarshalTo(dAtA[i:])
		if err10 != nil {
			return 0, err10
		}
		i += n10
